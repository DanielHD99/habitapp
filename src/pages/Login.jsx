      ...
      <div style={pageStyle}>
        <div style={cardStyle}>
          ...
          <button
            ...
            style={{ marginBottom: 'var(--space-4)', gap: 'var(--space-3)', justifyContent: 'center' }}
          >
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <><div className="spinner" style={{ width: 20, height: 20, borderWidth: 2 }} /> Iniciando sesión…</> : 'Iniciar sesión'}
            </button>
          </form>
          ...
          <p style={{ textAlign: 'center', marginTop: 'var(--space-6)', fontSize: 'var(--font-size-sm)', color: 'var(--color-text-muted)' }}>
            ¿No tienes cuenta?{' '}
            <Link to="/registro" style={{ color: 'var(--color-primary)', fontWeight: 'var(--font-weight-semibold)', textDecoration: 'none' }}>
              Regístrate gratis
            </Link>
          </p>
        </div>
