      ...
      <div className="container">
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 'var(--font-size-sm)', color: 'rgba(255,255,255,0.6)', lineHeight: 'var(--line-height-relaxed)', maxWidth: 260 }}>
              Encuentra tu próximo hogar. La plataforma de arriendos de vivienda en Armenia, Quindío.
            </p>
          </div>
          ...
          <div>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)', fontSize: 'var(--font-size-sm)', color: 'rgba(255,255,255,0.6)' }}>
        ...
        <div style={{
          ...
          <span>Exclusivamente para <strong style={{ color: 'var(--color-primary)' }}>arriendos</strong> en Armenia, Quindío.</span>
        </div>
      </div>
    </footer>
  )
